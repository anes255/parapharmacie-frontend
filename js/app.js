...
class PharmacieGaherApp {
    ...
    // NEW: Load checkout page (ADDED FOR USER REQUEST)
        ...
        mainContent.innerHTML = `
            <div class="container mx-auto px-4 py-8 max-w-4xl">
                <div class="text-center mb-8">
                    ...
                    <p class="text-xl text-emerald-600">Complétez vos informations pour passer commande</p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <form id="checkoutForm" class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="checkoutAdresse" name="adresse" required rows="3"
                                              ...
                                              placeholder="Adresse complète avec numéro de rue, cité, commune..."></textarea>
                                </div>
                                    ...
                                    <div class="space-y-3">
                                        <label class="flex items-center p-4 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-emerald-400 transition-all">
                                            <input type="radio" name="modePaiement" value="Paiement à la livraison" checked 
                                                   class="text-emerald-600 mr-4">
                                            <div class="flex items-center">
                                                <i class="fas fa-money-bill-wave text-emerald-600 text-xl mr-3"></i>
                                                <div>
                                                    <span class="font-semibold text-gray-800">Paiement à la livraison</span>
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-2xl shadow-xl border border-emerald-200/50 p-6 sticky top-4">
                            <h3 class="text-xl font-bold text-emerald-800 mb-6">Récapitulatif</h3>
                            
                            <!-- Cart Items -->
                            <div class="space-y-4 mb-6 max-h-60 overflow-y-auto">
                                ${this.cart.map(item => `
                                    <div class="flex items-center space-x-3 pb-3 border-b border-emerald-100">
                                        <img src="${item.image}" alt="${item.nom}" 
                                             class="w-12 h-12 object-cover rounded-lg border border-emerald-200">
                                        <div class="flex-1">
                                            <h4 class="font-medium text-gray-800 text-sm">${item.nom}</h4>
                            ...
                            <div class="space-y-3 border-t border-emerald-200 pt-4">
                                <div class="flex justify-between text-gray-700">
                                    ...
                                    <span id="checkoutSousTotal">${this.getCartTotal()} DA</span>
                                </div>
                                <div class="flex justify-between text-gray-700">
                                    <span>Livraison:</span>
    ...
    // NEW: Process order with success message (ADDED FOR USER REQUEST)
    async processOrder() {
    ...
    // NEW: Load order confirmation page (ADDED FOR USER REQUEST)
            ...
            <div class="container mx-auto px-4 py-8 max-w-3xl">
                <div class="text-center">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-2xl p-8 mb-8 shadow-2xl">
                            <h1 class="text-4xl font-bold mb-4">
                                <i class="fas fa-paper-plane mr-3"></i>
                                Commande envoyée !
                            </h1>
                            <p class="text-xl text-green-100">
                                Votre commande a été envoyée avec succès et sera traitée dans les plus brefs délais.
                            </p>
                        </div>
                    </div>

                    <!-- Order Details -->
                    <div class="bg-white rounded-2xl shadow-xl border border-emerald-200/50 p-8 mb-8">
                        <h2 class="text-2xl font-bold text-emerald-800 mb-6">Détails de votre commande</h2>
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                            <div>
                                <h3 class="font-semibold text-gray-800 mb-2">Numéro de commande</h3>
                                <p class="text-2xl font-bold text-emerald-600">#${orderNumber}</p>
                            </div>
                            
                            <div>
                                <h3 class="font-semibold text-gray-800 mb-2">Date de commande</h3>
                                <p class="text-gray-600">${new Date().toLocaleDateString('fr-FR', { 
                                    weekday: 'long', 
                                    year: 'numeric', 
                                    month: 'long', 
                                    day: 'numeric' 
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-800 mb-2">Mode de paiement</h3>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-2xl p-8 mb-8">
                        <h3 class="text-xl font-bold text-blue-800 mb-4">Prochaines étapes</h3>
                        <div class="space-y-4 text-left">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 class="font-semibold text-blue-800">Confirmation de commande</h4>
                                    <p class="text-blue-600 text-sm">Nous traiterons votre commande sous 24h et vous confirmerons par email/téléphone</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-3">
                                <div class="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center font-bold text-sm">2</div>
                                <div>
                                    <h4 class="font-semibold text-blue-800">Préparation</h4>
                                    <p class="text-blue-600 text-sm">Nos équipes préparent soigneusement votre commande</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-3">
                                <div class="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center font-bold text-sm">3</div>
                                <div>
                                    <h4 class="font-semibold text-blue-800">Livraison</h4>
                                    <p class="text-blue-600 text-sm">Livraison à votre adresse sous 2-5 jours ouvrables</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-emerald-50 border border-emerald-200 rounded-2xl p-6 mb-8">
                        <h3 class="text-lg font-bold text-emerald-800 mb-3">Besoin d'aide ?</h3>
                        <p class="text-emerald-700 mb-4">Notre équipe est à votre disposition pour toute question</p>
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="mailto:pharmaciegaher@gmail.com" 
                               class="inline-flex items-center justify-center bg-emerald-600 text-white px-6 py-3 rounded-lg hover:bg-emerald-700 transition-all">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <button onclick="app.showPage('products')" 
                                class="bg-gradient-to-r from-emerald-500 to-green-600 text-white px-8 py-4 rounded-xl hover:from-emerald-600 hover:to-green-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 font-bold">
                            <i class="fas fa-shopping-bag mr-2"></i>
                            Continuer vos achats
                        </button>
                        <button onclick="app.showPage('home')" 
                                class="bg-gray-500 text-white px-8 py-4 rounded-xl hover:bg-gray-600 transition-all font-bold">
...
console.log('✅ Original app.js restored with ONLY checkout and order confirmation features added');
