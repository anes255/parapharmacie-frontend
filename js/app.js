        ...
        try {
            ...
            try {
                ...
                orders = localOrders.filter(order => 
                    order.client && 
                    order.client.userId === this.currentUser.id
                );
            }
        ...
        ordersContent.innerHTML = `
            <div class="space-y-6">
                ${orders.map(order => {
                    ...
                    const clientAddress = client.adresse || 'Adresse non renseignée';
                    const clientWilaya = client.wilaya || '';
                        ...
                        <div class="bg-white rounded-2xl shadow-lg border border-emerald-100 overflow-hidden hover:shadow-xl transition-all duration-300">
                            ...
                            <div class="bg-gradient-to-r from-emerald-50 to-green-50 px-6 py-4 border-b border-emerald-100">
                                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                    <div>
                                        <h3 class="text-xl font-bold text-emerald-800">Commande #${orderNumber}</h3>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        ...
                                        <div class="space-y-3">
                                            ${articles.map(article => `
                                                <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                                                    ...
                                                    <div class="flex-1">
                                                        <p class="font-medium text-gray-900">${article.nom || 'Produit sans nom'}</p>
                                                        <p class="text-sm text-gray-600">Quantité: ${article.quantite || 1} × ${article.prix || 0} DA</p>
                                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="bg-gray-50 rounded-lg p-4 space-y-2">
                                            ...
                                            ${clientWilaya ? `<p class="text-gray-900"><span class="font-medium">Wilaya:</span> ${clientWilaya}</p>` : ''}
                                            <p class="text-gray-900">
                                        ...
                                        ${status === 'en-attente' ? `
                                            <div class="mt-4">
                                                <button onclick="app.cancelOrder('${order._id}')" 
...
console.log('✅ Fixed app.js loaded with proper admin integration and orders functionality');
