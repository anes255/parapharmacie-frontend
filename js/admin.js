...
// Orders Management - FIXED to call /orders/admin endpoint
PharmacieGaherApp.prototype.loadAdminOrders = async function() {
    try {
        ...
        // Try to merge with API orders - FIXED endpoint
        try {
            const data = await apiCall('/orders/admin');
            ...
            console.error('❌ Admin endpoint failed:', error.message);
