...
window.deleteOrder = deleteOrder; // NEW: Export delete order function
...
console.log('✅ Fixed Admin.js loaded with proper app integration and delete orders feature');
